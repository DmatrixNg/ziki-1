  ...
  <section id="main-content" class="container pt-0">
    <div class="row">
      ...
      <div class="col-lg-8 pb-0">
        ...
        <div class="container-fluid p-0 m-0 mb-5 d-flex justify-content-between justify-content-lg-end">
          ...
          @else
        <div class="dropdown">
            <a class="mr-5 pr-4 notification text-main" id="load" role="button" id="dropdownNotification" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon ion-md-notifications" style="font-size: 1.8em; cursor:pointer"></i>
    ...
    height: 2vw;"></div>
          ...
          <div class="dropdown" id="lucid-dropdown">
            <a class="nav-link dropdown-toggle pt-1" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="cursor:pointer">
